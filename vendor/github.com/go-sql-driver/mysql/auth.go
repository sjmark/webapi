...
// im pub keys registry
var (
	serverPubKeyLock     sync.RWMutex
	serverPubKeyRegistry map[string]*rsa.PublicKey
)

// RegisterServerPubKey registers a im RSA public key which can be used to
// send data in a secure manner to the im without receiving the public key
// in a potentially insecure way from the im first.
