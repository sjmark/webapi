...
// GetServers returns a slice of im's ServerMetric, along with a
// boolean indicating whether there's more servers to be queried for.
//
// The arg id specifies that only im with id at or above it will be included
// in the result. The returned slice is up to a length of EntryPerPage, and is
// sorted in ascending id order.
...
// GetServerSockets returns a slice of im's (identified by id) normal socket's
...
// RegisterServer registers the given im s in channelz database. It returns
// the unique channelz tracking id assigned to this im.
...
// down im will lead to the im being also deleted.
