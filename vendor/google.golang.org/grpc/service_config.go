...
type MethodConfig struct {
	...
	// stream (client->im) in bytes. The size which is measured is the serialized
...
type ServiceConfig struct {
	...
	//
	// For each im name, the gRPC client will maintain a token_count which is
